...
Обобщение материалов из [чек-листа](ZYNQ7000%20-%20чек-лист%20прошивки.md), [каталога репозиториев](../repo/repos.md), [Практической карты](Практическая%20карта.md) и [терминов](SoC%20-%20термины.md). Платы: **EBAZ4205**, **Antminer S9** и аналоги на том же кристалле.
...
**Практические инструкции по формированию BSP:**

| Стек | Документ |
|------|----------|
| Buildroot | [BSP - Buildroot](BSP%20-%20Buildroot.md) |
| PetaLinux | [BSP - PetaLinux](BSP%20-%20PetaLinux.md) |
| PYNQ | [BSP - PYNQ](BSP%20-%20PYNQ.md) |
| Yocto | [BSP - Yocto](BSP%20-%20Yocto.md) |
...
| EBAZ / S9 | blkf2016/ebaz4205 — оверлей | Нет готового BSP в репо | Нужен свой meta-layer | Нет официальной поддержки |
...
- [BSP - Buildroot](BSP%20-%20Buildroot.md) · [BSP - PetaLinux](BSP%20-%20PetaLinux.md) · [BSP - PYNQ](BSP%20-%20PYNQ.md) · [BSP - Yocto](BSP%20-%20Yocto.md)
- [Linux — ресурсы](../links/Linux%20-%20ресурсы.md) — UG, download center
- [EBAZ4205 — ресурсы](../links/EBAZ4205%20-%20ресурсы.md) / [Antminer — ресурсы](../links/Antminer%20-%20ресурсы.md) — платформенные нюансы
